...
**How to Run**
1. Create the database and stored procedures using the provided SQL script.
2. Update the connection string in appsettings.json.
3. Open the solution in Visual Studio 2022.
4. Press F5 to run the Web API.
5. Open the UI at `https://localhost:xxxx/index.cshtml`.
